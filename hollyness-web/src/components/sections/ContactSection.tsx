...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true)
    // Simulate API call — replaced with real FastAPI endpoint in backend step
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <span className="text-[#C8D5E5] text-sm leading-relaxed">
                    Plot No. 1532, Old Forest St., BOT Road,<br />
                    P.O. Box 741, Mbeya, Tanzania
                  </span>
                </li>
                <li className="flex gap-3">
                  <PhoneIcon className="w-5 h-5 text-[#D4A017] flex-shrink-0" />
                  <div className="text-sm">
                    <a href="tel:+255762058614" className="text-[#C8D5E5] hover:text-[#D4A017] transition-colors block">
                      +255 762 058 614
                    </a>
                  </div>
                </li>
